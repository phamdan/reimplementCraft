...
parser.add_argument('--trained_model', default='./pretrain/data/CRAFT-pytorch/synweights/synweights50.pth', type=str, help='pretrained model')
...
image_list, _, _ = file_utils.get_files('./pretrain/data/CRAFT-pytorch/test')

result_folder = './pretrain/data/CRAFT-pytorch/result/'
